...
class ValidationError extends Error {
  ...
  console.log(detectTriangle(3,2,3))
  console.log(detectTriangle(2,3,1))
  console.log(detectTriangle(false,3,1))
  console.log(detectTriangle(2,3,false))
  console.log(detectTriangle(2,false,1))